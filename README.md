...
NEXT_PUBLIC_INDUSTRY_DEMO_WIDGET_EMBED_KEY=...   # required to render live widget on /industries pages
NEXT_PUBLIC_WIDGET_SCRIPT_SRC=https://app.vizzion.io/widget.js
