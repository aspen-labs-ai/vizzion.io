    ...
    <section className="py-24 px-6 bg-gray-50" id="pricing">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
          ...
          {/* Starter */}
          <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-accent transition-all duration-250 hover:shadow-xl">
            <div className="text-lg font-semibold text-gray-700 mb-4">Starter</div>
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-accent shadow-xl relative transform md:-translate-y-2">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-accent text-primary text-sm font-bold">
              Most Popular
            </div>
            <div className="text-lg font-semibold text-gray-700 mb-4">Professional</div>
            ...
            <div className="mb-8 p-3 bg-accent/10 rounded-lg">
              <div className="text-sm font-bold text-primary">Average ROI: 247%</div>
            ...
            <a 
              href="#" 
              className="block w-full text-center px-6 py-3 font-semibold rounded-lg bg-accent text-primary hover:bg-accent-hover transition-all duration-250 hover:-translate-y-0.5 hover:shadow-md"
            >
              Start Free Trial
            </a>
          </div>
          ...
          {/* Enterprise */}
          <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-accent transition-all duration-250 hover:shadow-xl">
            <div className="text-lg font-semibold text-gray-700 mb-4">Enterprise</div>
            <div className="flex items-baseline mb-8">
