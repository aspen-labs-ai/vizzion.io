  ...
  return (
    <section className="py-24 px-6" id="dashboard">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Dashboard Mockup */}
        <div className="mb-16">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200 max-w-6xl mx-auto">
            {/* Mac-style Header */}
            <div className="bg-gray-100 px-4 py-3 flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#FF5F57]"></div>
              <div className="w-3 h-3 rounded-full bg-[#FEBC2E]"></div>
              <div className="w-3 h-3 rounded-full bg-[#28C840]"></div>
              <span className="ml-4 text-sm text-gray-600">Vizzion Dashboard</span>
            </div>
              ...
              <div className="flex-1 p-8 bg-white">
                ...
                <div className="grid grid-cols-3 gap-6 mb-8">
                  <div className="p-6 bg-white border border-gray-200 rounded-xl">
                    <div className="text-sm text-gray-600 mb-2">Total Visualizations</div>
                  ...
                  <div className="p-6 bg-accent/10 border border-accent rounded-xl">
                    ...
                    <div className="text-3xl font-bold text-primary mb-2">24.3%</div>
                    <div className="flex items-center gap-2 text-sm text-green-600">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 12V4M4 8l4-4 4 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <div className="p-6 bg-white border border-gray-200 rounded-xl">
                    ...
                    <div className="text-sm text-gray-600">2 new today</div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex gap-2">
                      <button className="px-3 py-1 text-sm rounded bg-gray-100">7D</button>
                      <button className="px-3 py-1 text-sm rounded bg-accent text-primary">30D</button>
                      <button className="px-3 py-1 text-sm rounded bg-gray-100">90D</button>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div className="flex-shrink-0 w-32 text-sm text-gray-700">Asphalt Shingles</div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-shrink-0 w-32 text-sm text-gray-700">Metal Roofing</div>
                      <div className="flex-1 h-8 bg-gray-100 rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-shrink-0 w-32 text-sm text-gray-700">Clay Tiles</div>
                      <div className="flex-1 h-8 bg-gray-100 rounded-full overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <h4 className="text-xl font-bold mb-2 text-primary">Real-Time Analytics</h4>
            <p className="text-gray-700">Track engagement, conversions, and user behavior as it happens.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-xl font-bold mb-2 text-primary">Material Management</h4>
            <p className="text-gray-700">Add, edit, and organize your product catalog with ease.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-xl font-bold mb-2 text-primary">Custom Branding</h4>
            <p className="text-gray-700">White-label the experience with your logo, colors, and style.</p>
          </div>
        </div>
      </div>
    </section>
