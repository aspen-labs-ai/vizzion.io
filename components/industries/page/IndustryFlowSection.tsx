...
import IndustryFlowSteps from './IndustryFlowSteps';

const STEP_ICONS = [Code2, Eye, Mail];

export default function IndustryFlowSection({ data }: { data: IndustryData }) {
  ...
  return (
    <section
      id="how-it-works"
      className="relative border-y border-border-subtle bg-bg-secondary px-6 py-28 md:py-32"
    >
      <script
      ...
      <div className="relative mx-auto max-w-[1180px]">
        ...
        <IndustryFlowSteps steps={stepsWithIcons} />
      </div>
    </section>
  );
}
