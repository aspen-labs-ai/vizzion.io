...
export default function RoofingProblemSection({ data }: { data: IndustryData }) {
  const { context } = data;

  return (
    <section className="relative overflow-hidden border-t border-border-subtle px-6 py-28 md:py-32">
      <div className="roofing-shingle-grid pointer-events-none absolute inset-0 opacity-[0.35]" aria-hidden />
