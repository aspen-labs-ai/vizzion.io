  ...
  const industryGroups: IndustryGroup[] = [
    {
      ...
      industries: [
        ...
        },
        {
          icon: Waves,
          name: 'Swimming Pools',
          description: 'Help homeowners visualize their dream pool in their actual backyard. From freeform lagoons to geometric lap pools, customers see the finished result before signing a $50K contract.',
          href: '/industries/swimming-pools',
          image: '/images/industries/swimming-pools.png'
        },
        {
          icon: Sprout,
          name: 'Artificial Turf',
          description: 'Show drought-conscious homeowners exactly how artificial turf transforms their yard. Upload a photo of patchy grass, see a lush green lawn — without a single sprinkler.',
          href: '/industries/artificial-turf',
          image: '/images/industries/artificial-turf.png'
        },
      ],
    },
    {
      ...
      industries: [
        ...
        },
        {
          icon: Ship,
          name: 'Boat Decking',
          description: 'Marine dealers and refurbishment shops: let boat owners see premium decking materials on their actual vessel. From SeaDek foam to synthetic teak, visualize the upgrade before the install.',
          href: '/industries/boat-decking',
          image: '/images/industries/boat-decking.png'
        },
      ],
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-text-primary">
            Built for businesses that sell visual transformations
          </h2>
        ...
        {industryGroups.map((group) => (
          <div key={group.label} className="mb-12 last:mb-0">
            ...
            <div className="flex items-center gap-4 mb-6">
              <h3 className="text-sm font-semibold uppercase tracking-wider text-text-tertiary whitespace-nowrap">
                {group.label}
              </h3>
