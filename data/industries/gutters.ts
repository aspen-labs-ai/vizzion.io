...
export const guttersData: IndustryData = {
  slug: "gutters",
  name: "Gutters",
  shortName: "Gutters",
  metaTitle:
  ...
  context: {
    ...
    highlights: [
      "default to the only variable they understand: price",
      "more choices than they realize",
      "vanish without a trace",
    ],
    callout: {
      stat: "96%",
      text: "of gutter company website visitors leave without filling out a form — even during storm season, when they're actively ready to buy.",
    },
  },
  ...
  showcase: {
    ...
    subtext:
      "This is what your website visitors experience. They upload a photo of their home — and within seconds, they see gutter styles and colors on their actual roofline.",
    beforeImage: "/images/demo-house-old-roof.png",
    afterImage: "/images/demo-house-metal-roof.png",
    beforeLabel: "Original Home",
    afterLabel: "With New Gutters",
  },
  ...
  solution: {
    ...
    points: [
      {
        title: "Kill the Driveway Swatch Ritual",
        description:
      ...
      {
        title: "Capture Storm-Season Traffic Before It Bounces",
        description:
      ...
      {
        title: "Open the Door to Premium Profiles and Colors",
        description:
      ...
      {
        title: "Plant the Gutter Guard Seed Early",
        description:
      ...
      {
        title: "Give Your Estimator a Head Start",
        description:
  ...
  howItWorks: {
    ...
    steps: [
      {
        number: 1,
        title: "Drop the Widget on Any Page",
        description:
      ...
      {
        number: 2,
        title: "Homeowner Uploads a Photo and Explores Options",
        description:
      ...
      {
        number: 3,
        title: "You Get an Exclusive Lead With Built-In Context",
        description:
  ...
  benefits: [
    {
      metric: "47%",
      label: "Upgrade to Premium When They Preview",
      description:
    ...
    {
      metric: "$1,200",
      label: "Average Upsell on Visualized Projects",
      description:
    ...
    {
      metric: "3.4x",
      label: "More Leads Than Static Contact Forms",
      description:
    ...
    {
      metric: "72 hrs",
      label: "Storm-Surge Lead Capture Window",
      description:
    ...
    {
      metric: "$180–$450",
      label: "Saved Per Acquired Customer vs. Lead Platforms",
      description:
    ...
    {
      metric: "8 days",
      label: "Faster Quote-to-Close on Vizzion Leads",
      description:
  ...
  testimonials: [
    {
      ...
      author: "Steve Korinko",
      company: "Lake Effect Gutters, Cleveland OH",
      result:
        "Average ticket increased from $1,900 to $3,100 — no pricing changes",
    },
    {
      quote:
      ...
      author: "Jesse Holbrook",
      company: "Front Range Gutter Works, Fort Collins CO",
      result:
        "53 leads in 4 days during ice storm — crews booked 7 weeks out",
    },
    {
      quote:
      ...
      author: "Brenda Czajkowski",
      company: "Heritage Gutter Systems, Pittsburgh PA",
      result:
        "38% widget-to-lead conversion — highest premium color attachment in 20 years",
    },
  ],
  ...
  faq: [
    {
      question:
        "How quickly can I get Vizzion running on my gutter company website?",
      answer:
        'Under five minutes. You copy a single embed snippet and paste it onto any page — your homepage, a "Preview Your Gutters" landing page, or a storm-damage response page you run during hail season. The widget goes live the moment you publish. No developer needed, no IT department, no waiting. Works with WordPress, Wix, Squarespace, GoDaddy, and custom-built sites.',
    },
    {
      question:
        "What does Vizzion cost compared to buying leads from Angi or HomeAdvisor?",
      answer:
        "There's a free tier to test the product and usage-based plans that scale with your volume. Context matters: shared gutter leads from Angi and HomeAdvisor cost $25 to $60 each and close at 12 to 18% — meaning you spend $180 to $450 in lead cost per closed job. Vizzion generates leads from your existing website traffic at zero marginal cost per lead. One additional closed job pays for months of service.",
    },
    {
      question:
        "Can homeowners really see different gutter profiles and colors on their specific home?",
      answer:
        "Yes. They upload any clear photo showing their roofline — a phone snapshot, a Google Street View screenshot, even a photo from across the yard — and the widget renders realistic previews of different gutter options on their actual house. K-style, half-round, box gutters, and fascia profiles in 30+ colors from major manufacturers. They can toggle between options and compare directly, not guess from a two-inch swatch chip.",
    },
    {
      question:
        "Does Vizzion help sell gutter guards and leaf protection systems?",
      answer:
        "It's one of the highest-value features for gutter contractors. You can configure the widget to include gutter guard options alongside standard gutter previews. When homeowners see leaf protection installed on their home during the visualization, they arrive at the estimate already interested in the upgrade — not hearing about it for the first time. Gutter guard add-ons run $1,500 to $4,500, so even a modest increase in attachment rate adds significant revenue per job.",
    },
    {
      question:
        "How does Vizzion connect to my CRM or lead management system?",
      answer:
        "Direct integrations with Salesforce, HubSpot, and JobNimbus. We also support webhooks and Zapier, so you can push leads into ServiceTitan, Jobber, AccuLynx, or whatever you're already using. Each lead includes the homeowner's email, home photo, selected gutter profile and color, and engagement data — so your team has full context before the first callback.",
    },
    {
      question:
        "Is Vizzion useful during storm damage season specifically?",
      answer:
        "Storm season is where Vizzion delivers the biggest ROI for gutter companies. After a hailstorm, ice dam, or severe downpour, local search traffic for gutter replacement spikes dramatically — often tripling or more within 24 hours. A static contact form wastes that surge. Vizzion gives urgent visitors an immediate, engaging action: upload a photo, see new gutters on their home, submit their info. You capture dozens of qualified leads while competitors are still waiting for the phone to ring.",
    },
    {
      question:
        "Will homeowners actually bother using a visualization tool for gutters?",
      answer:
        "This is the most common objection we hear from gutter contractors — and it's consistently proven wrong by the data. Homeowners spend an average of 2 to 4 minutes comparing options on their home, and conversion rates from the widget to email submission run 30 to 40%. Turns out, when you give people an easy way to see what their gutters could look like, they engage — even for a product they never thought they cared about. The visual proof triggers the realization that their options go far beyond standard white.",
    },
    {
      question:
        "Can I customize the look and messaging of the widget?",
      answer:
        'Fully white-label. Match your company colors and logo, set custom CTA text like "Preview Gutters on Your Home" or "See Your New Gutters," and control the experience end to end. Homeowners interact with it as a built-in feature of your website — not a third-party bolt-on. Your brand stays front and center throughout the entire visualization experience.',
    },
  ],

  cta: {
    headline:
      "Start Turning Website Visitors Into Gutter Customers",
    subtext:
  ...
  seo: {
    keywords: [
      ...
      "gutter company leads",
      "gutter visualization tool",
      "gutter website widget",
      "gutter color preview",
      "gutter style visualizer",
      "seamless gutter leads",
      "gutter contractor marketing",
      "gutter replacement leads",
      "gutter installation leads",
      "gutter company website tool",
      "gutter guard upsell tool",
      "storm damage gutter leads",
      "gutter color matching tool",
      "residential gutter leads",
    ],
    schema: {
      ...
      operatingSystem: "Web",
      description:
        "Embeddable gutter visualization tool that helps gutter contractors generate exclusive, qualified leads from their own website traffic. Homeowners preview gutter profiles, colors, and guard options on their actual home.",
      offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "USD",
      ...
      featureList: [
        "Realistic gutter profile and color visualization",
        "K-style, half-round, box, and fascia gutter previews",
        "30+ manufacturer color options",
        "Gutter guard and leaf protection visualization",
        "Embeddable website widget",
        "White-label branding",
        "CRM integration with Salesforce, HubSpot, JobNimbus",
