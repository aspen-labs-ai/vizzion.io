...
export const drivewaysData: IndustryData = {
  slug: "driveways",
  ...
  seo: {
    keywords: [
      ...
      "paving company leads",
      "paver driveway visualization",
      "driveway design preview tool",
      "hardscape lead generation",
      "paver visualization widget",
      "driveway contractor marketing",
      "paving website lead capture",
      "interlocking paver preview",
      "stamped concrete visualization",
      "driveway replacement leads",
      "paving company website tool",
      "hardscape website conversion",
      "driveway paver comparison tool",
      "paving contractor lead generation software",
    ],
    schema: {
